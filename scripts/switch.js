// Expresion
const diaDeLaSemana = function (numero) {
  if (numero === 1) {
    return "Lunes";
  } else if (numero === 2) {
    return "Martes";
...
// const dia = diaDeLaSemana(2);
// console.log(dia);

// function encontrarDia(numero) {
//   switch (numero) {
//     case 1:
//       return "Lunes";
//     case 2:
...
//     break;
//   default:
//     console.log("Día incorrecto, vuelve a intentarlo!");
// }
